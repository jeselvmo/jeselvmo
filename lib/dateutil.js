...
var __global__ = void 0,
    date_parsers = void 0,
    date_formatters = void 0;
...
var Dateutil = function () {
	function Dateutil() {
		...
		date_formatters = this._formats = {
			...
			// ISO 8601 date
			c: function c(d, l) {
				return __global__.isoyear(d) + __global__.format(d, '-m-d\\TH:i:s.', l) + __global__.pad(d.getUTCMilliseconds(), 3) + 'Z';
			},
			// Day of the month, 2 digits with leading zeros
			d: function d(_d2) {
				return __global__.pad(_d2.getUTCDate());
			},
			...
			l: function l(d, _l) {
				return __global__._(_d[d.getUTCDay()], _l);
			},
	...
	_createClass(Dateutil, [{
		key: 'date',
		value: function date(y, m, d, h, n, s, ms) {
			if (!arguments.length) {
		...
		key: 'format',
		value: function format(d, fmt, lang) {
